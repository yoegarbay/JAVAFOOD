...
public class EmpleadoRepository extends BaseRepository<Empleado> {
    ...
    @Override public String[] getColumnNames()   { return new String[]{"id","nombre","iniciales","color","activo"}; }
    @Override public void setPrimaryKey(Empleado e, int id) { e.setId(id); }
    @Override public Object[] getInsertValues(Empleado e) {
        return new Object[]{e.getNombre(), e.getIniciales(), e.getColor(), e.getActivo() != null ? e.getActivo() : true};
    }
    @Override public Object[] getUpdateValues(Empleado e) {
        return new Object[]{e.getNombre(), e.getIniciales(), e.getColor(), e.getActivo(), e.getId()};
    }
