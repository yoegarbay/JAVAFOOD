...
document.getElementById("nav-nombre").textContent = cliente?.nombre || "";
document.getElementById("hero-sub").textContent = "Pedidos de " + (cliente?.nombre || "");
document.getElementById("nav-logout").addEventListener("click", e => {
    e.preventDefault();
    sessionStorage.removeItem("jfCliente");
...
async function cargar() {
    try {
        ...
        const misPedidos = todos.filter(p =>
            (p.nombreCliente || "").toLowerCase().trim() ===
